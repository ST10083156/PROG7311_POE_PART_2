...
namespace PROG7311_POE_PART_2.Controllers
{
    public class ProductController : Controller
    {
        ...
        {
            var agriEnergyContext = _context.Products.Include(p => p.ProductType).Include(p => p.User);
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,DateProd,ProductTypeId,UserId")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,DateProd,ProductTypeId,UserId")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
